...
void Rotary_Encoder::oled_Link(MyOLED* oled_obj)
{
    this->oled_obj = oled_obj;
}

void Rotary_Encoder::CLICK_ISR()
{
...
void Rotary_Encoder::SWITCH_ISR()
{
...
void Rotary_Encoder::update_ms(unsigned long ms)
{
    last_milli_sec = ms;
}

unsigned long Rotary_Encoder::get_ms()
{
